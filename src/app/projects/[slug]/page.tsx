...
const projects: Record<string, ProjectData> = {
  alpha: {
    ...
    year: "2024",
    client: "Отбасы Банк",
    services: ["Моушен-дизайн", "Анимация", "Брендинг"],
    description:
  ...
  beta: {
    ...
    services: ["VFX", "Түсірілім", "Постпродакшн"],
    description:
  ...
  gamma: {
    ...
    services: ["Логотип", "Бренд-гайд", "Визуалды айдентика"],
    description:
  ...
  nur: {
    ...
    services: ["Инфографика", "Визуал", "Корпоративті стиль"],
    description:
      "Графикалық иллюстрациялар, инфографика және визуалды материалдар дайындау.",
    images: [
  ...
  get: {
    ...
    services: ["Моушен-дизайн", "Анимация", "Бренд"],
    description:
      "Бұл жоба клиенттің брендін жаңғырту үшін жасалған моушен-дизайн және анимацияны қамтиды.",
    images: [
